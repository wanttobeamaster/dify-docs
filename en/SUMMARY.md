...
* [Quick Start](plugins/quick-start/README.md)
  ...
  * [Develop Plugins](plugins/quick-start/develop-plugins/README.md)
    ...
    * [Model Plugin](plugins/quick-start/develop-plugins/model-plugin/README.md)
      ...
      * [Integrate the Predefined Model](plugins/quick-start/develop-plugins/model-plugin/integrate-the-predefined-model.md)
    ...
    * [Best Practice](plugins/quick-start/develop-plugins/best-practice/README.md)
      * [Developing a Plugin that Integrated with Telegram Bot](plugins/quick-start/develop-plugins/best-practice/developing-a-plugin-that-integrated-with-telegram-bot.md)
