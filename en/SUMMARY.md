...
* [Quick Start](plugins/quick-start/README.md)
  * [Install and Use Plugins](plugins/quick-start/install-and-use-plugins.md)
* [Develop Plugins](plugins/develop-plugins/README.md)
  * [Initialize Development Tools](plugins/develop-plugins/initialize-development-tools.md)
  * [Tool Plugin](plugins/develop-plugins/tool-plugin.md)
  * [Model Plugin](plugins/develop-plugins/model-plugin/README.md)
    * [Create Model Providers](plugins/develop-plugins/model-plugin/create-model-providers.md)
    * [Integrate the Predefined Model](plugins/develop-plugins/model-plugin/integrate-the-predefined-model.md)
    * [Debug Plugin](plugins/develop-plugins/model-plugin/debug-plugin.md)
  * [Extension Plugin](plugins/develop-plugins/extension-plugin.md)
  * [Bundle](plugins/develop-plugins/bundle.md)
  * [Best Practice](plugins/develop-plugins/best-practice/README.md)
    * [Developing a Plugin that Integrated with Telegram Bot](plugins/develop-plugins/best-practice/developing-a-plugin-that-integrated-with-telegram-bot.md)
* [Manage Plugins](plugins/manage-plugins.md)
* [Schema Definition](plugins/schema-definition/README.md)
...
* [Publish Plugins](plugins/publish-plugins/README.md)
  ...
  * [Publish to Your Personal GitHub Repository](plugins/publish-plugins/publish-to-your-personal-github-repository.md)
