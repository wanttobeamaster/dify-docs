...
* [Develop Plugins](plugins/develop-plugins/README.md)
  ...
  * [Model Plugin](plugins/develop-plugins/model-plugin/README.md)
    * [Creating Model Providers](plugins/develop-plugins/model-plugin/creating-model-providers.md)
    * [Access to Predefined Models](plugins/develop-plugins/model-plugin/access-to-predefined-models.md)
