...
After setting the indexing method, you can refer to the following documentation to choose the appropriate retrieval method. The chosen indexing method determines the background information accessible to the LLM, directly impacting the accuracy and reliability of the generated results.
